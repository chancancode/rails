...
module PostgresqlJsonTests
  ...
  class JsonbTest < ActiveRecord::TestCase
    setup do
      @connection = ActiveRecord::Base.connection
      begin
        @connection.transaction do
    ...
    def test_default
      @connection.add_column 'json_data_type', 'permissions', :jsonb, default: '{"users": "read", "posts": ["read", "write"]}'
      JsonDataType.reset_column_information
